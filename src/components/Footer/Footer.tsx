      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          <h5 className="mb-8 flex items-center gap-2">
            ...
            <span className="text-neutral text-lg font-medium">Thanks for Stopping By</span>
          </h5>
          <p className="text-tertiary-content">
            Just a glimpse into what I do — from breaking stuff (ethically) to building cool, secure
            things on the web. Always learning, always coding. Let’s connect if you’re into tech,
            ideas, or just good conversation.
          </p>
          <a
            href="#"
          ...
          <div className="space-y-10 md:self-end">
            <div className="flex flex-col">
              ...
              <a
                ...
                contact@niltonnovele.com <p style={{ fontSize: '9px' }}>(click me)</p>
              </a>
              <a
                href="tel:+27761915804"
                className="text-tertiary-content hover:text-neutral text-sm font-light transition-colors duration-300">
                +27 (76) 191-5804
              </a>
            </div>
